...
const countries = (data) => {
  data.forEach((country) => {
    ...
    <div class="card-body text-center">
      ...
      <a href="https://api.openweathermap.org/data/2.5/weather?lat=${country.latlng[0]}&lon=${country.latlng[1]}&appid=016ce45c906240f839172d3f50e746af" class="btn btn-primary">Click for Weather</a>
    </div>
  </div></br>`
    row.appendChild(div)
  })
